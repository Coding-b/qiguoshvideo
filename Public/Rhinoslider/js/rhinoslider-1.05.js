...
(function ($, window, undefined) {
	...
	var rhinoSlider = function (element, opts) {
		...
		var
			...
			//pause the autoplay and change the bg-img of the button to "play"
			pause = function () {
			...
			//start/resume the autoplay and change the bg-img of the button to "pause"
			play = function () {
				var vars = $slider.data('slider:vars');
				vars.intervalAutoPlay = setInterval(function () {
					next($slider, settings);
	...
	$.fn.rhinoslider.defaults = {
		...
		parts: '5,3',
		//show img-title: hover, always, never
		showCaptions: 'never',
