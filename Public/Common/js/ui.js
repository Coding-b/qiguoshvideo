...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="http://qiguostudy.qiniudn.com/image%2Floading.gif" style="width: 100px;height: 100px"/>');

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', 'http://qiguostudy.qiniudn.com/image%2Fdefault.png');
