...
class BCS_MimeTypes {
	public static $mime_types = array (
			...
			'bin' => 'application/octet-stream', 'bmp' => 'img/bmp',
			'cdf' => 'application/x-netcdf', 'cgm' => 'img/cgm',
			'class' => 'application/octet-stream',
			'cpio' => 'application/x-cpio',
			'cpt' => 'application/mac-compactpro',
			'csh' => 'application/x-csh', 'css' => 'text/css',
			'dcr' => 'application/x-director', 'dif' => 'video/x-dv',
			'dir' => 'application/x-director', 'djv' => 'img/vnd.djvu',
			'djvu' => 'img/vnd.djvu',
			...
			'gif' => 'img/gif', 'gram' => 'application/srgs',
			'grxml' => 'application/srgs+xml',
			'gtar' => 'application/x-gtar', 'gz' => 'application/x-gzip',
			'hdf' => 'application/x-hdf',
			'hqx' => 'application/mac-binhex40', 'htm' => 'text/html',
			'html' => 'text/html', 'ice' => 'x-conference/x-cooltalk',
			'ico' => 'img/x-icon', 'ics' => 'text/calendar',
			'ief' => 'img/ief', 'ifb' => 'text/calendar',
			'iges' => 'model/iges', 'igs' => 'model/iges',
			'jnlp' => 'application/x-java-jnlp-file', 'jp2' => 'img/jp2',
			'jpe' => 'img/jpeg', 'jpeg' => 'img/jpeg',
			'jpg' => 'img/jpeg', 'js' => 'application/x-javascript',
			'kar' => 'audio/midi', 'latex' => 'application/x-latex',
			'lha' => 'application/octet-stream',
			'lzh' => 'application/octet-stream',
			'm3u' => 'audio/x-mpegurl', 'm4a' => 'audio/mp4a-latm',
			'm4p' => 'audio/mp4a-latm', 'm4u' => 'video/vnd.mpegurl',
			'm4v' => 'video/x-m4v', 'mac' => 'img/x-macpaint',
			...
			'ogv' => 'video/ogv', 'pbm' => 'img/x-portable-bitmap',
			'pct' => 'img/pict', 'pdb' => 'chemical/x-pdb',
			'pdf' => 'application/pdf',
			'pgm' => 'img/x-portable-graymap',
			'pgn' => 'application/x-chess-pgn', 'pic' => 'img/pict',
			'pict' => 'img/pict', 'png' => 'img/png',
			'pnm' => 'img/x-portable-anymap',
			'pnt' => 'img/x-macpaint', 'pntg' => 'img/x-macpaint',
			'ppm' => 'img/x-portable-pixmap',
			'ppt' => 'application/vnd.ms-powerpoint',
			'ps' => 'application/postscript', 'qt' => 'video/quicktime',
			'qti' => 'img/x-quicktime', 'qtif' => 'img/x-quicktime',
			'ra' => 'audio/x-pn-realaudio',
			'ram' => 'audio/x-pn-realaudio', 'ras' => 'img/x-cmu-raster',
			'rdf' => 'application/rdf+xml', 'rgb' => 'img/x-rgb',
			...
			'sv4crc' => 'application/x-sv4crc', 'svg' => 'img/svg+xml',
			'swf' => 'application/x-shockwave-flash',
			't' => 'application/x-troff', 'tar' => 'application/x-tar',
			'tcl' => 'application/x-tcl', 'tex' => 'application/x-tex',
			'texi' => 'application/x-texinfo',
			'texinfo' => 'application/x-texinfo', 'tif' => 'img/tiff',
			'tiff' => 'img/tiff', 'tr' => 'application/x-troff',
			...
			'xbm' => 'img/x-xbitmap', 'xht' => 'application/xhtml+xml',
			'xhtml' => 'application/xhtml+xml',
			'xls' => 'application/vnd.ms-excel',
			'xml' => 'application/xml', 'xpm' => 'img/x-xpixmap',
			'xsl' => 'application/xml', 'xslt' => 'application/xslt+xml',
			'xul' => 'application/vnd.mozilla.xul+xml',
			'xwd' => 'img/x-xwindowdump', 'xyz' => 'chemical/x-xyz',
			'zip' => 'application/zip',
